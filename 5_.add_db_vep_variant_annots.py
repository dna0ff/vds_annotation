...
vds_mgrb = hc.read('tmp/04.cohort.minrep.af.vds')
...
vds_1000g_freqs = hc.read('/vds/databases/1000G.split.minrep.freqs.vds')
vds_hrc_freqs = hc.read('/vds/databases/HRC.minrep.vds')
vds_gnomad_freqs = hc.read('/vds/databases/gnomad/gnomad.genomes.r2.0.1.sites.combined.split.minrep.vds')

vds_dbsnp = hc.read('/vds/databases/dbSNP/dbSNP_150.split.minrep.vds')
vds_clinvar = hc.read('/vds/databases/clinvar.vds')
vds_eigen = hc.read('/vds/databases/Eigen_coding_04092016.vds')
vds_cato = hc.read('/vds/databases/CATO_1.1.vds')

vds_mgrb_split_freqs = hc.read('tmp/05_mgrb_simpleafs.vds')
vds_vep = hc.read('tmp/05_mgrb_split_variants.vep.vds')
#vds_cadd = hc.read('/vds/databases/CADD_1.3.vds')
...
vds_mgrb = (vds_mgrb
    ...
    .annotate_variants_expr('va = select(va, variant, alleles, genotypes)')
)

# TODO: Add gene-level annotations (eg GAVIN, RVIS)

vds_mgrb.write('../cohort.annotated.vds')
