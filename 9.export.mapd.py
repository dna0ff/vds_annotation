...
# Exports VDS to tsv summary stats for MapD interactive charts.
# The only difference compare to the ssvs summary stats is 
# this does not contain tgpAF or hrcAF.

from hail import *
hc = HailContext(log = 'log/09.export.mapd.log', tmp_dir = 'tmp/hail')
...
kt = kt.select([u'VARIANT', u'CHROMOSOME', u'START', u'REF', u'ALT', u'RSID', u'AC', u'AF', u'nHomRef', u'nHet', u'nHomVar', u'TYPE', 'CATO', 'eigen', 'sift', 'polyPhen', 'gnomadAF', 'gnomadAF_AFR', 'gnomadAF_AMR', 'gnomadAF_ASJ', 'gnomadAF_EAS', 'gnomadAF_FIN', 'gnomadAF_NFE','gnomadAF_OTH', 'consequences', 'geneSymbol','clinvar'])

kt.export("../export.mapd.tsv")
